/**
 * Part 2: Tracking - Analytics General (ALL user IDs)
...
export const analytics_general = {
    ...
    woopra: { domain: '', enabled: false },
    statcounter: { projectId: '', enabled: false },
    swetrix: { projectId: '', enabled: false },
    panelbear: { siteId: '', enabled: false },
    matomo: { url: '', siteId: '', enabled: false },
    clicky: { siteId: '', enabled: false }
};

export const analytics_general_priority = ['ga4', 'yandex', 'posthog', 'mixpanel', 'amplitude', 'heap', 'logrocket', 'umami', 'cloudflare', 'goatcounter', 'beam', 'counter_dev', 'cronitor', 'clarity'];
