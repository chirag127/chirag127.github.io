    ...
    footer.innerHTML = `
      <div class="footer-container">
        <div class="footer-brand">
          <div class="logo-text">Chirag Hub</div>
          <p>© ${new Date().getFullYear()} Chirag Singhal. Open Source.</p>
        </div>
        <div class="footer-links">
          <a href="/privacy">Privacy</a>
          <a href="/terms">Terms</a>
          <a href="https://github.com/chirag127/chirag127.github.io" target="_blank">Source</a>
        </div>
      </div>
    `;
